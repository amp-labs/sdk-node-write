...
export interface Env {
  SDKNODEWRITE_API_KEY_HEADER?: string | undefined;

  SDKNODEWRITE_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  SDKNODEWRITE_API_KEY_HEADER: z.string().optional(),

  SDKNODEWRITE_DEBUG: z.coerce.boolean().optional(),
});
